...
def xmas_check(input_lst: list, condition: list):
    ...
    for row in list(range(0, len(input_lst) - 2, 1)):
        ...
        for col in list(range(0, len(input_lst[0]) - 2, 1)):
            ...
            if (
                input_lst[row][col] == condition[0]
                and input_lst[row][col + 2] == condition[1]
                and input_lst[row + 1][col + 1] == "A"
                and input_lst[row + 2][col] == condition[2]
                and input_lst[row + 2][col + 2] == condition[3]
            ):
                xmas_count += 1
